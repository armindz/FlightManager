...
public class AirportDatabase {
	...
	public ArrayList<Airport> fetchDatabaseContent(ArrayList<Airport> airports) { // mechanism for fetching content from database and returning as ArrayList
		...
		try {
			...
			while (rset.next()) {
				...
				Airport airport = new Airport(rset.getString("Airport_Codename"), rset.getString("Airport_Fullname"),
						rset.getString("Airport_Type"), rset.getString("Airport_City"), rset.getString("Airport_Country"));
	...
	public void updateDatabaseContent(String Airport_Codename,String Airport_Fullname, String Airport_Type,String Airport_City, String Airport_Country) {
	...
	public void deleteContentFromDatabase(String Airport_Codename) { // deleting from database content found using Airport_Codename as it is unique
